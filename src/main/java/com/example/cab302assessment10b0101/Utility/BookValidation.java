...
public class BookValidation {
     ...
     */
    public boolean validFields(String title, Boolean isNewTitle, String isbn, String author, String description, String publisher, String pages, String notes, String readingStatus) {
        ...
        if ( isNewTitle ) { if ( titleExists(title) ) { AlertManager.getInstance().showAlert("Error: Title Exists", titleExistsMessage, Alert.AlertType.ERROR); return false; } }
    ...
    private boolean isValidISBN(String isbn) {
        ...
        // Check if all characters in the string are digits (including 0-9)
